...
import { CompanyNewStepOneComponent } from "./new/step-one/step-one.component";
import { CompanyNewStepTwoComponent } from './new/step-two/step-two.component';
...
@NgModule({
    declarations: [
        ...
        CompanyNewComponent,
        CompanyNewStepOneComponent,
        CompanyNewStepTwoComponent
    ],
    imports: [
